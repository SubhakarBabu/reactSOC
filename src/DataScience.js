...
function DataScience() {
  return (
    <div>
    <img className="image"  alt="null" src='https://cdn.analyticsvidhya.com/wp-content/uploads/2023/07/4594dcf8-a8c5-4fa7-a6d4-bab2c9081041.jpg'></img>
    <h1 className="head"> What is Data Science?</h1>
    <p className="text">Data science combines math and statistics, specialized programming, advanced analytics, artificial intelligence (AI), and machine learning with specific subject matter expertise to uncover actionable insights hidden in an organization’s data. These insights can be used to guide decision making and strategic planning.
    ...
    The data science lifecycle involves various roles, tools, and processes, which enables analysts to glean actionable insights. Typically, a data science project undergoes the following stages:</p>



    <h1 className="head"> History of Data Science</h1>
    <p className="text">While the term data science is not new, the meanings and connotations have changed over time. The word first appeared in the ’60s as an alternative name for statistics. In the late ’90s, computer science professionals formalized the term. A proposed definition for data science saw it as a separate field with three aspects: data design, collection, and analysis. It still took another decade for the term to be used outside of academia. </p>

    <h1 className="head"> Data Science is Used for?</h1>
    
    <p className="text">1. Descriptive analysis <br></br>
